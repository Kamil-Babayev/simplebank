...
func (m *MockStore) TransferTx(ctx context.Context, arg db.TransferTxParam) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccountData(ctx context.Context, arg db.UpdateAccountDataParams) (db.Account, error) {
	m.ctrl.T.Helper()
