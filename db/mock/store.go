...
func (m *MockStore) TransferTx(ctx context.Context, arg sqlc.TransferTxParam) (sqlc.TransferTxResult, error) {
	m.ctrl.T.Helper()
...
// UpdateAccountData mocks base method.
func (m *MockStore) UpdateAccountData(ctx context.Context, arg sqlc.UpdateAccountDataParams) (sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAccountData", ctx, arg)
	ret0, _ := ret[0].(sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateAccountData indicates an expected call of UpdateAccountData.
func (mr *MockStoreMockRecorder) UpdateAccountData(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAccountData", reflect.TypeOf((*MockStore)(nil).UpdateAccountData), ctx, arg)
}
